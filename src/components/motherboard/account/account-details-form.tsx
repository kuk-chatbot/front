              ...
              <Grid container spacing={3}>
                ...
                <Grid md={6} xs={12}>
                  <FormControl fullWidth required>
                    ...
                    <Select label="Memory" name="memory" value={memory} onChange={(e) => setMemory(e.target.value)}>
                      <MenuItem value="" disabled>
                        <em>Select Memory</em>
                      </MenuItem>
                ...
                <Grid md={6} xs={12}>
                  <FormControl fullWidth required>
                    ...
                    <Select label="Cores" name="cores" value={cores} onChange={(e) => setCores(e.target.value)}>
                      <MenuItem value="" disabled>
                        <em>Select Cores</em>
                      </MenuItem>
                ...
                <Grid md={6} xs={12}>
                  <FormControl fullWidth required>
                    ...
                    <Select label="Sockets" name="sockets" value={sockets} onChange={(e) => setSockets(e.target.value)}>
                      <MenuItem value="" disabled>
